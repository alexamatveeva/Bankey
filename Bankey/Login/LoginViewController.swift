...
extension LoginViewController {
    private func style() {
        ...
        subtitleLabel.text = "Enter in your account"
        ...
        signInButton.configuration?.imagePadding = 8 //define the distance between an image and the text (for indicator spacing)
...
extension LoginViewController {
    ...
    private func login() {
        ...
        if username == "Sasha" && password == "Welcome" {
...
extension LoginViewController {
    private func animate() {
        ...
        animator3.startAnimation(afterDelay: duration/2)
        
        let animator4 = UIViewPropertyAnimator(duration: duration*2, curve: .easeInOut) {
            self.subtitleLabel.alpha = 1
            self.view.layoutIfNeeded()
        }
        animator4.startAnimation(afterDelay: duration/2)
    }
}
